...
class HelperToReadMongo(object):
    ...
    def connect_to_mongo(self, db, server_ip = None, ssh_username = None, ssh_password = None, \
                        remote = False, host = 'localhost', port = 27017, username = None, password = None):
    ...
    def query_to_mongo(self, db_name, collection_name, server_ip=None, ssh_username=None, ssh_password=None, \
                       remote = False, features = None, query = {}, url = 'localhost', port = 27017, username = None, password = None, no_id = True):              # Connect to Mongodb Server
    	# Connect to MongoDB
        db = self.connect_to_mongo(db = db_name, host = url, port = port, server_ip = server_ip, ssh_username = ssh_username, ssh_password = ssh_password, remote = remote)
